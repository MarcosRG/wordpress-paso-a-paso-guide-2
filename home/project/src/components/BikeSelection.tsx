    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 mb-4">
          No se pudo conectar con la API de WooCommerce.
          {error instanceof Error ? error.message : 'Error desconocido'}
        </p>
        <p className="text-sm text-gray-500 mb-4">
          ❌ Solo se mostrarán datos reales de WooCommerce (sin datos de respaldo)
        </p>
  ...
  if (!bikes || bikes.length === 0) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 mb-4">
          No se encontraron bicicletas en el inventario de WooCommerce.
        </p>
        <p className="text-sm text-gray-500 mb-4">
          ℹ️ Solo se muestran productos reales del sistema - sin datos de prueba
        </p>
