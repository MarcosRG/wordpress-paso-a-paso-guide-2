...
export const ConnectivityStatus: React.FC = () => {
  ...
  const getStatusIcon = () => {
    ...
    if (status.consecutiveErrors >= 1) return <WifiOff className="h-4 w-4 text-red-500" />;
  ...
  const getStatusBadge = () => {
    ...
    if (status.consecutiveErrors >= 1) return <Badge variant="destructive">Bloqueado</Badge>;
