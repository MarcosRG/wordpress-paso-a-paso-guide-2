  ...
  return useQuery({
    ...
    queryFn: async (): Promise<Bike[]> => {
      try {
        ...
        console.log('Error al conectar con WooCommerce, usando datos de prueba:', error);
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<string[]> => {
      try {
        ...
        console.log('Categorías obtenidas de WooCommerce:', Array.from(categories));
        return Array.from(categories);
      } catch (error) {
        console.log('Error al obtener categorías de WooCommerce, usando categorías de prueba:', error);
